...
struct Network {
	...
	IoT_Error_t (*read)(Network *, unsigned char *, size_t, awsTimer *, size_t *);    ///< Function pointer pointing to the network function to read from the network
	IoT_Error_t (*write)(Network *, unsigned char *, size_t, awsTimer *, size_t *);    ///< Function pointer pointing to the network function to write to the network
 ...
 */
IoT_Error_t iot_tls_read(Network *, unsigned char *, size_t, awsTimer *, size_t *);
