...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              (char*)"a1075elwyht7bd.iot.us-west-2.amazonaws.com"
#define AWS_IOT_MQTT_PORT              443                      
#define AWS_IOT_MQTT_CLIENT_ID         (char*)"c-sdk-client-id" 
#define AWS_IOT_MY_THING_NAME           (char*)"AWS-IoT-C-SDK"   
#define AWS_IOT_ROOT_CA_FILENAME        (char*)"rootCA.crt"      
#define AWS_IOT_CERTIFICATE_FILENAME   (const char*) "cert.pem"        
#define AWS_IOT_PRIVATE_KEY_FILENAME   (const char*) "privkey.pem"     
// =================================================
